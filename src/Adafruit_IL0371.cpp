...
*/
/**************************************************************************/
Adafruit_IL0371::Adafruit_IL0371(int width, int height, int8_t SID, int8_t SCLK, int8_t DC, int8_t RST, int8_t CS, int8_t SRCS, int8_t spi_miso, int8_t BUSY) : Adafruit_EPD(width, height, SID, SCLK, DC, RST, CS, SRCS, spi_miso, BUSY){
#else
/**************************************************************************/
/*!
